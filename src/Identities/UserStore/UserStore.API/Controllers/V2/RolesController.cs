...
using UserStore.Application.Features.Queries.Roles.GetRole.ById;
...
namespace UserStore.API.Controllers.V2
{
    ...
    public class RolesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetRoleById(Guid id)
        {
            ...
            {
                _logger.LogInformation("GetRoleById ArgumentNullException {Id}", id);
            ...
            {
                const string SAFE_ERROR_MESSAGE = "An error occurred while retrieving the role";
                _logger.Log(LogLevel.Error, ex, SAFE_ERROR_MESSAGE);
