...
namespace DocuStore.Infrastructure.Consumers
{
    public class ConsumerHostedService : IHostedService
    {
        ...
        {
            _logger.LogInformation("[Starting] DocuStore consumer hosted service for topic: {@topic}", _topic);
        ...
        {
            _logger.LogInformation("[Stopping] DocuStore consumer hosted service");
            return Task.CompletedTask;
        }
    }
}