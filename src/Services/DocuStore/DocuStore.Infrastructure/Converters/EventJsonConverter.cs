...
namespace DocuStore.Infrastructure.Converters
{
    public class EventJSONConverter : JsonConverter<BaseEvent>
    {
        ...
        public override BaseEvent? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            {
                "ParsedDocAddedEvent" => JsonSerializer.Deserialize<ParsedDocAddedEvent>(json, options),
                "ParsedDocUpdatedEvent" => JsonSerializer.Deserialize<ParsedDocUpdatedEvent>(json, options),
                "ParsedDocDeletedEvent" => JsonSerializer.Deserialize<ParsedDocDeletedEvent>(json, options),
