...
using Project.Infrastructure.Query.Converters;
...
namespace Project.Infrastructure.Query.Consumers
{
            ...
            while (true)
            {
                try
                {
                    ...
                    while (true)
                    {
                        ...
                        {
                            _logger.LogInformation("ProjectEventConsumer: Skipping event {message} as the event was not understood. (Acknowledged)", consumeResult.Message.Value);
                        ...
                        catch (Exception ex)
                        {
                            ...
                            throw new EventConsumeException(nameof(ProjectEventConsumer), $"Error deserializing event: {consumeResult.Message.Value}", ex);
                        }
